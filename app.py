...
try:
    ...
    if pagina == "🏠 Inicio":
        try:
                        ...
                        for j in range(2):
                            ...
                            if idx < len(df_filtrado):
                                ...
                                with cols[j]:
                                    ...
                                    # Tooltip con descripcion completa
            ...
            st.error(f"Error en pagina Inicio: {e}")
    ...
    # ============================================================
        ...
        try:
            ...
            st.error(f"Error en pagina Agregar: {e}")
            st.code(traceback.format_exc())
    ...
    # ============================================================
        ...
        try:
            ...
            st.error(f"Error en pagina Buscar: {e}")
            st.code(traceback.format_exc())
    ...
    # ============================================================
        ...
        try:
            ...
            st.error(f"Error en pagina Estadisticas: {e}")
            st.code(traceback.format_exc())
